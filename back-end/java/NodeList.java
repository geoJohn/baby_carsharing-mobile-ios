...
import com.lc.core.protocol.nodecluster.common.LCExtendConfig.NodePort;
import com.lc.core.protocol.nodecluster.common.LCExtendConfig.NodePort.PortType;
import com.lc.core.protocol.nodecluster.common.LCNodeInfo.NodeInfo;
...
public class NodeList {
	...
	public static String getLocalIpAddress(long nodeCode) {
		...
		return cache.get(nodeCode).getLocalIpAddress();
	}
	...
	public static String getInternetIpAddress(long nodeCode) {
		...
		return cache.get(nodeCode).getInternetIpAddress();
	}
